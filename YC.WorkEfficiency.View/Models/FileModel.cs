...
namespace YC.WorkEfficiency.View.Models
{
    ...
    public class FileModel : ObservableObject
    {
        ...
        public string AfterTime
        {
            ...
            set { _afterTime = value; RaisePropertyChanged(); }
        }
        ...
        public string FileTitle
        {
            ...
            set { _FileTitle = value; RaisePropertyChanged(); }
        }
        ...
        public bool IsFinished
        {
            ...
            set { _IsFinished = value; RaisePropertyChanged(); }
        }

        [Column("IsSelected")]
        public bool IsSelected { get => isSelected; set { isSelected = value; RaisePropertyChanged(); } }
        #endregion 属性
